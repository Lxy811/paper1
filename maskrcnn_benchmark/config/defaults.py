...
_C.MODEL.ROI_BOX_HEAD.META_ARCH = "Default"
...
_C.MODEL.ROI_RELATION_HEAD.PRUNE_RATE = 0.0
_C.MODEL.ROI_RELATION_HEAD.LAMBDA_ = 0.01

_C.MODEL.ROI_RELATION_HEAD.TRANSFORMER = CN()
# for TransformerPredictor only    TRANSFORMER.OBJ_LAYER = 4 我换成了3层
...
_C.MODEL.ROI_RELATION_HEAD.SOFTTRIPLE=False
_C.MODEL.ROI_RELATION_HEAD.SOFTTRIPLE_LAMBDA=0.0
_C.MODEL.ROI_RELATION_HEAD.SOFTTRIPLE_GAMMA=0.0
_C.MODEL.ROI_RELATION_HEAD.SOFTTRIPLE_TAU=0.0
_C.MODEL.ROI_RELATION_HEAD.SOFTTRIPLE_MARGIN=0.0
_C.MODEL.ROI_RELATION_HEAD.SOFTTRIPLE_K=1
_C.MODEL.ROI_RELATION_HEAD.SOFTTRIPLE_MARGIN_INFER=False
...
_C.MODEL.ROI_RELATION_HEAD.DECOUPLE_INPUT = False
# _C.MODEL.ROI_RELATION_HEAD.LOSS_TRICK = False
_C.MODEL.ROI_RELATION_HEAD.GPR_TYPE = "default"
_C.MODEL.ROI_RELATION_HEAD.MP_LAYER_NUM = 2
...
_C.TEST.RELATION.PRE_NMS_PREDICTION_THRES = 0.3
...
_C.TEST.CUSTUM_PATH = '.'
_C.TEST.ESTIMATE_EVAL = False
_C.TEST.ESTIMATE_K = 2
_C.TEST.ESTIMATE_TAU = 0.1
_C.TEST.LOAD_ESTIMATE = False
# ---------------------------------------------------------------------------- #
# Misc options
# ---------------------------------------------------------------------------- #
_C.OUTPUT_DIR = "."
...
#PPR value
_C.MODEL.ROI_RELATION_HEAD.PPR_ALPHA = -0.5
